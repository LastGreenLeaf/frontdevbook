...
```
Здесь `h1` - самый главный заголовок, а `h6` наименее важный. Заголовки одного типа могут повторяться на странице.

Правилом хорошего тона является отсутствие пропусков в номерах заголовков. То есть вместо использования `h1`, `h4` и `h6`, стоит выбрать `h1`, `h2` и `h3`. Это также позволяет упростить работу со структурой текста.
