...
__HTML__ (eng. _Hypertext markup language_) - это язык гипертекстовой разметки, который позволяет описать структуру веб-страниц с её __контентом__ (т.е. содержимым старницы).
...
Веб - это огромная база знаний, в которой содержится невероятно количество текстовой информации (преимущественно о котах, конечно же). Однако обойтись лишь текстовой информацией трудно. Человек по своей природе привык усваивать все с визуальным сопровождением. Так почему бы не добавить фотографий?

```html
<img src="http://random.cat/i/UwL2m.jpg">
```
<div style="text-align: center;">
  <img src="http://random.cat/i/UwL2m.jpg">
</div>

Используя элемент `img` мы столкнулись с двумя любопытными особенностями:
1. Тег `<img>` не является парным, а значит не имеет закрывающего соответствующего тега
2. Расположение изображения, которое мы отобразить указывалось в __атрибуте__ (eng. _Attribute_)

Об атрибутах мы поговорим, но немного позднее.
