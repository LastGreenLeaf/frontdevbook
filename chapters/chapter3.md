...
В предыдущих главах мы выяснили как организовать структуру сплошного текста - использовали заголовки, абзацы и другие подобные элементы. На этот раз мы определимся со структурой контента, поделенного на смысловые блоки.

Но прежде чем мы перейдем к частям, поговорим о целом. Действительно, ведь и сам контент, как целое, является важным компонентом любой веб-страницы и его необходимо как-то записать в HTML-коде.

Нам повезло, ведь В 5-м стандарте языка как раз был добавлен элемент `main`, который определяет область основного содержимого страницы.

```html
<main>
  <h1>Крайне интересная статья о котах</h1>
  <p>...</p>
  <p>...</p>
  <p>...</p>
</main>
...
Этот элемент должен содержать главный контент страницы - тот материал, ради которого пользователь открыл веб-страницу.

Не стоит помещать в этот элемент ссылки (если это не оглавление), логотип компании, юридическую и правовую информацию (если она не относится на прямую к теме).

И уж тем более не стоит помещать в `main` не уникальный для страницы контент, который может повторяться и в других разделах сайта. Рекламный блок, виджеты, поиск - это не то, что следует класть в `main`.

Вот плохой пример использования `main`.
...
<main>
  ...
  <h1>Обнаружен новый химический элемент - Котий</h1>
  <h2>Мнение признанного эксперта в области химии</h2>
  <p>...</p>
  <p>...</p>
  <p>...</p>
  <aside>
  ...
  <footer>
    <small>Разработчик сайта: Fluffy Studio</small>
  </footer>
</main>
```
...
<main>
  <header>
    <h1>Обнаружен новый химический элемент - Котий</h1>
    <p>Мнение признанного эксперта в области химии</p>
  </header>
  <p>...</p>
  <p>...</p>
  <p>...</p>
  <footer>
    <small>Автор статьи: Шикарные усы</small>
  </footer>
</main>
...
<footer>
  <p>Разработчик сайта: Fluffy Studio</p>
  <p>Все права защищены.</p>
</footer>
```

Согласно стандарту это элемент должен присутствовать на странице в единственном экземпляре и желательно, чтобы он находился внутри тега `<body>`, а не вкладывался куда-либо еще. В целом это разумно, ведь самая главная информация на странице обычно сгруппирована в общий блок.
